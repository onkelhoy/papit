...
const VOID_ELEMENTS = new Set(['meta', 'link', 'br', 'hr', 'img', 'input', 'area', 'base', 'col', 'embed', 'param', 'source', 'track', 'wbr'])
...
export default class Element extends Node {
    ...
    get outerHTML(): string {
        ...
        return `${this._outerHTML}${(!VOID_ELEMENTS.has(this.tagName) || this.innerHTML || this.tagName === "script" || this.tagName.includes("-")) ? `>${this.innerHTML ?? ""}</${this.tagName}>` : " />"}`;
