...
a collection of intersection game logic 
...
[![NPM version](https://img.shields.io/npm/v/@papit/intersection.svg?logo=npm)](https://www.npmjs.com/package/@papit/intersection)
...
```bash
npm install @papit/intersection
```
