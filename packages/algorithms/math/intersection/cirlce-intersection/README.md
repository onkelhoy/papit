# @papit/cirlce-intersection

a simple cirlce intersection lib 
...
[![NPM version](https://img.shields.io/npm/v/@papit/cirlce-intersection.svg?logo=npm)](https://www.npmjs.com/package/@papit/cirlce-intersection)
...
```bash
npm install @papit/cirlce-intersection
```
