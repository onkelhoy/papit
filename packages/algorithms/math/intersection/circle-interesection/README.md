# @papit/circle-interesection

a simple circle intersection lib 
...
[![NPM version](https://img.shields.io/npm/v/@papit/circle-interesection.svg?logo=npm)](https://www.npmjs.com/package/@papit/circle-interesection)
...
```bash
npm install @papit/circle-interesection
```
