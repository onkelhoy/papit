...
Signaling server mainly for webrtc handshake
...
[![NPM version](https://img.shields.io/npm/v/@papit/signal-server.svg?logo=npm)](https://www.npmjs.com/package/@papit/signal-server)
...
```bash
npm install @papit/signal-server
```
